...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[Report_V4_Orders]
...
case when qq.DateSent is null then 'Not Sent' else 'Sent' + ' - ' + isnull(convert(char(10),qq.DateSent,103),0) end [Order Sent?] --added 07/08/2018 LI - Atom: 74229
from Ordering_Delivery od
join Ordering_DeliveryItems odi on odi.DeliveryId = od.Id and odi.SourceType not in (1,2,3,4,6)
left join Queue_Queue qq on qq.DeliveryId = od.DeliveryID --added 07/08/2018 LI - Atom: 74229
